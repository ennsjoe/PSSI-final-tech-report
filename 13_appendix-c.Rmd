# APPENDIX `r new_appendix()`. Summary of DFO Science PSSI Data Projects {#app:data}
...
```{r, echo=FALSE, fig.align="center", fig.cap="Figure C.1 - Screen capture of the Salmon Tracking Escapement Assessment and Management (STREAM) Platform with the table of contents visible."}
...
```{r, echo=FALSE, fig.align="center", fig.cap="Figure C.2 - Screen capture of Salmon Space showing the Osoyoos-Skaha-Okanagan Sockeye conservation unit (highlighted) with associated information displayed in a pop-up."}
# Tables and Figures with images
data_fig_dir <- here("figures", "data_tools_figures")
...
```{r, echo=FALSE, fig.align="center", fig.cap="Figure C.3 - Screen capture of STAMP."}
# Tables and Figures with images
data_fig_dir <- here("figures", "data_tools_figures")

if (dir.exists(data_fig_dir)) {

  knitr::include_graphics(file.path(data_fig_dir, "Figure3.png"))
...
```{r, echo=FALSE, fig.align="center", fig.cap="Figure C.4 - Screen capture of SILScanner."}
# Tables and Figures with images
data_fig_dir <- here("figures", "data_tools_figures")

if (dir.exists(data_fig_dir)) {

  knitr::include_graphics(file.path(data_fig_dir, "Figure4.png"))
...
```{r, echo=FALSE, fig.align="center", fig.cap="Figure C.5 - Screen capture of DocFlow."}
# Tables and Figures with images
data_fig_dir <- here("figures", "data_tools_figures")

if (dir.exists(data_fig_dir)) {

  knitr::include_graphics(file.path(data_fig_dir, "Figure5.png"))
