...
```{r stream-figure, echo=FALSE, fig.width = "auto", fig.height = "auto", fig.cap="Figure C.1 - Screen capture of the Salmon Tracking Escapement Assessment and Management (STREAM) Platform with the table of contents visible."}
...
```{r salmon-space-figure, echo=FALSE, fig.width = "auto", fig.height = "auto", fig.cap="Figure C.2 - Screen capture of Salmon Space showing the Osoyoos-Skaha-Okanagan Sockeye conservation unit (highlighted) with associated information displayed in a pop-up."}
...
```{r stamp-figure, echo=FALSE, fig.width = "auto", fig.height = "auto", fig.cap="Figure C.3 - Screen capture of STAMP."}
...
```{r silscanner-figure, echo=FALSE, fig.width = "auto", fig.height = "auto", fig.cap="Figure C.4 - Screen capture of SILScanner."}
...
```{r docflow-figure, echo=FALSE, fig.width = "auto", fig.height = "auto", fig.cap="Figure C.5 - Screen capture of DocFlow."}
